...
const LOCALES = {
    'zh-cn': {
        ...
        howToConfigureManual: '📖 如何获取与配置 PDF 手册？(Setup Guide)',
        modifyManualPath: '修改手册路径',
        hasManualPackReady: '请问您是否已经准备好 LS-DYNA 手册与 SumatraPDF 的整合包或文件夹？',
        btnYesSelectFolder: '已准备，选择目录',
        btnDownloadPack: '下载即插即用包',
        btnCancel: '取消',
        page: '第 {0} 页',
        openNewTab: '在新标签打开链接',
        openSplit: '分栏打开',
        ...
        matchingDefinitionsFound: '$(warning) 找到 {0} 个匹配定义。请先检查重复或歧义，再信任预览结果。',
        moreDefinitionsOmitted: 'Hover 中已省略 {0} 个定义。',
        openDefinition: '打开定义',
        ...
        failedToSplitOpenFile: '分栏打开文件失败：{0}',
        failedToRevealFolder: '显示文件夹失败：{0}',
        fieldCommentCompletionDetail: '(LS-DYNA) 插入字段注释行',
        fieldCommentCompletionTitle: '插入字段注释行',
        fieldCommentCompletionInsertHint: '按下 Tab 将插入：',
        rowTemplateDocumentation: '插入一整行预对齐的数据卡片模板。',
        includedFileNotFound: '引用文件 "{0}" 未找到。',
        circularIncludeDependency: '检测到循环 Include 依赖：{0}',
    ...
    'en': {
        ...
        howToConfigureManual: '📖 PDF Manual Setup Guide',
        modifyManualPath: 'Modify manuals directory',
        hasManualPackReady: 'Have you prepared the LS-DYNA manuals and SumatraPDF pack/folder?',
        btnYesSelectFolder: 'Yes, Select Folder',
        btnDownloadPack: 'Download Plug-and-Play Pack',
        btnCancel: 'Cancel',
        page: 'Page {0}',
        ...
        moreDefinitionsOmitted: '{0} more definitions omitted from hover.',
        ...
        notOnAnyKeyword: 'Not on any keyword.',
        keywordHasNoFilenameCard: 'This keyword does not have a filename card.',
        keywordNotSupported: 'This keyword is not supported.',
        noFileToJumpTo: 'No file to jump to.',
        fileNotFound: '{0} not found.',
        noMoreKeywordsFound: 'No more keywords found.',
        noPreviousKeywordsFound: 'No previous keywords found.',
        ...
        fieldCommentCompletionDetail: '(LS-DYNA) Insert field comment line',
