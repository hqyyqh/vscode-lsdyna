...
const LOCALES = {
    'zh-cn': {
        ...
        keywordOptionsCodeLens: '$(gear) 切换可选卡片/后缀',
        keywordOptionsCodeLensWithSummary: '$(gear) 切换可选卡片/后缀：{0}',
        formatKeywordCodeLens: '$(wand) 格式化当前关键字结构',
        selectKeywordCodeLens: '$(symbol-keyword) 选中当前关键字',
    ...
    'en': {
        ...
        keywordOptionsCodeLens: '$(gear) Toggle Optional Cards/Suffixes',
        keywordOptionsCodeLensWithSummary: '$(gear) Toggle Optional Cards/Suffixes: {0}',
        formatKeywordCodeLens: '$(wand) Format keyword structure',
        selectKeywordCodeLens: '$(symbol-keyword) Select keyword',
