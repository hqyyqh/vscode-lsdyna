        ...
        try {
            ...
            assert.ok(
                hover.contents[0].value.startsWith(
                    '### <span style="color:var(--vscode-textLink-foreground);">**ENDENG**</span> *(real)*\n\nPercent change in energy ratio for termination of calculation. If undefined, this option is inactive.\n\n**Card Columns:**\n<table style="border: 1px solid var(--vscode-panel-border); text-align: center;"><tr><th style="border: 1px solid var(--vscode-panel-border); text-align: center;">1-10</th><th style="border: 1px solid var(--vscode-panel-border); text-align: center;">11-20</th><th style="border: 1px solid var(--vscode-panel-border); text-align: center;">21-30</th><th style="border: 1px solid var(--vscode-panel-border); text-align: center;">31-40</th><th style="border: 1px solid var(--vscode-panel-border); text-align: center;">41-50</th><th style="border: 1px solid var(--vscode-panel-border); text-align: center;">51-60</th></tr><tr><td style="border: 1px solid var(--vscode-panel-border); text-align: center;">ENDTIM</td><td style="border: 1px solid var(--vscode-panel-border); text-align: center;">ENDCYC</td><td style="border: 1px solid var(--vscode-panel-border); text-align: center;">DTMIN</td><td style="border: 1px solid var(--vscode-panel-border); text-align: center;"><span style="color:var(--vscode-badge-foreground);background-color:var(--vscode-badge-background);">**&nbsp;ENDENG&nbsp;**</span></td><td style="border: 1px solid var(--vscode-panel-border); text-align: center;">ENDMAS</td><td style="border: 1px solid var(--vscode-panel-border); text-align: center;">NOSOL</td></tr></table>'
                )
            );
        } finally {
